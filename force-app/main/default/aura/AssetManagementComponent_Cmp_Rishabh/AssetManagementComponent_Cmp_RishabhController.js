...
({
    ...
    downloadCSVFile : function (component, event, helper) { 
        //console.log('InsideDownloadFunctrion');
        //alert('InsideDownloadFunctrion');
       
        var dataTODownload = [];
        dataTODownload = component.get("v.data");
        var columnHeader = component.get("v.columns");
        
        var csv=helper.convertArrayOfObjectsToCSV(component,dataTODownload,columnHeader);
         //alert('csv'+csv);
        if(csv==null)
        {
            return;
        ...
        elementLink.download='Report.csv';
